    ...
    <section class="bottom-background">
      <section class="bottom-section">
        <div class="section about-me" id="about-me">
          ...
          <p v-if="lang === 'lv'">
            Mani sauc Ģirts, un jau vairākus gadus aizraujos ar mūziku, mākslu un kultūru kopumā. Šī aizraušanās ar radošumu ir kļuvusi par manu virzītājspēku, un pašlaik aktīvi strādāju, lai to pārvērstu par veiksmīgu profesionālo karjeru. Ikdienā nodarbojos ar muzicēšanu un vizuālo mākslu. Skaņas apstrādei un ierakstīšanai izmantoju Reaper, bet vizuālo materiālu apstrādei  Adobe Photoshop un DaVinci Resolve. Papildus tam arī programmēju. Programmējot izmantoju vairākas valodas: Vue.js, Next.js, Laravel, MySQL, PostgreSQL, C++, JUCE, Python un PHP. Mājaslapu dizainu veidošanai izmantoju Figma. Esmu bijis praksē SIA "All Media Group" priekš TV3, "grupApunts" un Rīgas Valsts tehnikumā.
          </p>
          <p v-else>
            My name is Ģirts and I have been passionate about music, art and culture in general for several years. This passion for creativity has become my driving force and I am now actively working to turn it into a successful professional career. I use Reaper when working with audio, and Adobe Photoshop and DaVinci Resolve for visuals. In addition, I also code. I use several programming languages: Vue.js, Next.js, Laravel, MySQL, PostgreSQL, C++, JUCE, Python and PHP. I use Figma for website design. I have interned at SIA "All Media Group" for TV3, "grupApunts" and Riga State Technical School.
          </p>
        </div>
