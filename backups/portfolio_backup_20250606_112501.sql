...
CREATE TABLE `audio` (
  ...
  `latvian_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `english_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `latvian_description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `english_description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `image_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cropped_image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mp3_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-06-06 11:25:01
